...
if not isfolder("ZHHub") then
    makefolder("ZHHub")
end
if not isfolder("ZHHub/Config") then
    makefolder("ZHHub/Config")
end
...
local ConfigFile = "ZHHub/Config/ZHHub_" .. gameName .. ".json"
...
local ZH = {}
function ZH:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "ZH X"
...
function ZH(msg, delay, color, title, desc)
    return ZH:MakeNotify({
        Title = title or "ZH",
...
function ZH:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "Zvios Hub"
    GuiConfig.Footer       = GuiConfig.Footer or "ZH :3"
    ...
    ZH.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ZH.Name = "ZH"
    ZH.ResetOnSpawn = false
    ZH.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = ZH

    DropShadowHolder.Position = UDim2.new(0, (ZH.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (ZH.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("ZH") then
            ZH:Destroy()
        end
    end
